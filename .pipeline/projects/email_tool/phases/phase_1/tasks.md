...
- [ ] Task 3: Create rule engine core
...
- [ ] Task 5: Write unit tests for parser
...
- [ ] Task 6: Write unit tests for rule engine
...
- [ ] Task 7: Write unit tests for config loader
...
- [ ] Task 8: Create sample data and integration test
